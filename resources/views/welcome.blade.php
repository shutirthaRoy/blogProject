    ...
    <body class="w3-light-grey">
        ...
        <div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
          <div class="w3-display-middle" style="white-space:nowrap;">
            <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">ROY'S <span class="w3-hide-small">BLOG</span> AREA</span>
          </div>
        </div>
        <div class="w3-content" style="max-width:1400px">
            ...
            <div class="w3-col l8 s12">
              ...
              @foreach ($all_posts as $post)
                <div class="w3-card-4 w3-margin w3-white">
                  <img src="{{ asset('images/'.$post->image) }}" alt="Nature" style="width:100%">
              ...
              <div class="w3-card w3-margin">
                ...
                <ul class="w3-ul w3-hoverable w3-white">
                  <li class="w3-padding-16">
                    <img src="{{ asset('img\Home\workshop.jpg') }}" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                    <span class="w3-large">Lorem</span><br>
                    <span>Sed mattis nunc</span>
                  </li>
                  <li class="w3-padding-16">
                    <img src="{{ asset('img\Home\gondol.jpg') }}" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                    <span class="w3-large">Ipsum</span><br>
                    <span>Praes tinci sed</span>
                  </li> 
                  <li class="w3-padding-16">
                    <img src="{{ asset('img\Home\skies.jpg') }}" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                    <span class="w3-large">Dorum</span><br>
                    <span>Ultricies congue</span>
                  </li>   
                  <li class="w3-padding-16 w3-hide-medium w3-hide-small">
                    <img src="{{ asset('img\Home\rock.jpg') }}" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            ...
            <p style="text-align:center;"><button class="w3-button w3-padding-large w3-white w3-border"><b>See MORE</b></button></p>
